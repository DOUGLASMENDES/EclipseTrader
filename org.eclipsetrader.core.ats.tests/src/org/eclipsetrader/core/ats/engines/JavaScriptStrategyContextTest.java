...
public class JavaScriptStrategyContextTest extends TestCase {
    ...
    public void testInstanceInstrumentProperty() throws Exception {
        ...
        JavaScriptStrategyContext context1 = new JavaScriptStrategyContext(sharedScope, instrument1, strategy);
        JavaScriptStrategyContext context2 = new JavaScriptStrategyContext(sharedScope, instrument2, strategy);
    ...
    public void testOnQuoteSetsQuoteProperty() throws Exception {
        ...
        JavaScriptStrategyContext context = new JavaScriptStrategyContext(sharedScope, instrument, strategy);
        context.onQuote(quote);

        Object result = context.get(JavaScriptStrategyContext.PROPERTY_QUOTE);
    ...
    public void testOnTradeSetsTradeProperty() throws Exception {
        ...
        Object result = context.get(JavaScriptStrategyContext.PROPERTY_TRADE);
    ...
    public void testOnBarSetsBarProperty() throws Exception {
        ...
        Object result = context.get(JavaScriptStrategyContext.PROPERTY_BAR);
