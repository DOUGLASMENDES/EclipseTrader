...
public class JavaScriptEngineRunnerTest extends TestCase {
    ...
    public void testContextInheritsSettings() throws Exception {
        JavaScriptEngineRunner runner = new JavaScriptEngineRunner(strategy, pricingEnvironment, account, broker);
        ...
        JavaScriptStrategyContext context = runner.getContextFor(instrument1);
