...
public class DirectaWorldPlugin extends AbstractUIPlugin 
{
	...
	public DirectaWorldPlugin() 
  {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("net.sourceforge.eclipsetrader.directaworld.DirectaworldPluginResources");
  ...
  {
		ResourceBundle bundle = DirectaWorldPlugin.getDefault().getResourceBundle();
		try {
