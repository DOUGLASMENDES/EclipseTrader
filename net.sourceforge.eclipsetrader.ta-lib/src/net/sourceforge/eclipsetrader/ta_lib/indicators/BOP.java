...
public class BOP extends Factory
{
    public static final String DEFAULT_LABEL = Messages.BOP_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.BOP_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.BOP_Label, DEFAULT_LABEL); //$NON-NLS-1$

                addLineTypeSelector(content, "lineType", Messages.BOP_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
            }
        };
