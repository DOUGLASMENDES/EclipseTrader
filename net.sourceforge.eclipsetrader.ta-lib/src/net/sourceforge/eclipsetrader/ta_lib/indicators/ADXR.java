...
public class ADXR extends Factory
{
    public static final String DEFAULT_LABEL = Messages.ADXR_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.ADXR_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.ADXR_Label, DEFAULT_LABEL); //$NON-NLS-1$

                addLineTypeSelector(content, "lineType", Messages.ADXR_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addIntegerValueSelector(content, "period", Messages.ADXR_Period, 1, 9999, DEFAULT_PERIOD); //$NON-NLS-1$
            }
        };
