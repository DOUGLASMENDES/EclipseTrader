...
{
    private static final String DEFAULT_LABEL = Messages.TYPPRICE_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.TYPPRICE_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.TYPPRICE_Label, DEFAULT_LABEL); //$NON-NLS-1$
                addLineTypeSelector(content, "lineType", Messages.TYPPRICE_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
            }
        };
