    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public Combo addMovingAverageSelector(Composite parent, String id, String text, int defaultValue)
            {
                ...
                combo.add(Messages.MA_Simple);
                combo.add(Messages.MA_Exponential);
                combo.add(Messages.MA_Weighted);
                combo.add(Messages.MA_DoubleExponential);
                combo.add(Messages.MA_TripleExponential);
                combo.add(Messages.MA_Triangular);
                combo.add(Messages.MA_KaufmanAdaptive);
