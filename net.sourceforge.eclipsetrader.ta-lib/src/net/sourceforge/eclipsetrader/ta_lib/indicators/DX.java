...
public class DX extends Factory
{
    public static final String DEFAULT_LABEL = Messages.DX_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.DX_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.DX_Label, DEFAULT_LABEL); //$NON-NLS-1$

                addLineTypeSelector(content, "lineType", Messages.DX_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addIntegerValueSelector(content, "period", Messages.DX_Period, 1, 9999, DEFAULT_PERIOD); //$NON-NLS-1$
            }
        };
