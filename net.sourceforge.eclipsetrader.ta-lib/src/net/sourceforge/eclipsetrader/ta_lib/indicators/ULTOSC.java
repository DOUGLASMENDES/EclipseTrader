...
public class ULTOSC extends Factory
{
    public static final String DEFAULT_LABEL = Messages.ULTOSC_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.ULTOSC_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.ULTOSC_Label, DEFAULT_LABEL); //$NON-NLS-1$
                addLineTypeSelector(content, "lineType", Messages.ULTOSC_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addIntegerValueSelector(content, "shortPeriod", Messages.ULTOSC_ShortPeriod, 1, 9999, DEFAULT_SHORT_PERIOD); //$NON-NLS-1$
                addIntegerValueSelector(content, "mediumPeriod", Messages.ULTOSC_MediumPeriod, 1, 9999, DEFAULT_MEDIUM_PERIOD); //$NON-NLS-1$
                addIntegerValueSelector(content, "longPeriod", Messages.ULTOSC_LongPeriod, 1, 9999, DEFAULT_LONG_PERIOD); //$NON-NLS-1$
            }
        };
