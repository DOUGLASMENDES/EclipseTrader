...
public class CCI extends Factory
{
    public static final String DEFAULT_LABEL = Messages.CCI_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.CCI_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.CCI_Label, DEFAULT_LABEL); //$NON-NLS-1$

                addLineTypeSelector(content, "lineType", Messages.CCI_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addIntegerValueSelector(content, "period", Messages.CCI_Period, 1, 9999, DEFAULT_PERIOD); //$NON-NLS-1$
            }
        };
