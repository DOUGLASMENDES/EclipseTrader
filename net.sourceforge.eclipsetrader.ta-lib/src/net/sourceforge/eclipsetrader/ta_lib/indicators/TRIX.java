...
public class TRIX extends Factory
{
    public static final String DEFAULT_LABEL = Messages.TRIX_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.TRIX_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.TRIX_Label, DEFAULT_LABEL); //$NON-NLS-1$
                addLineTypeSelector(content, "lineType", Messages.TRIX_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addInputSelector(content, "input", Messages.TRIX_Input, DEFAULT_INPUT, false); //$NON-NLS-1$
                addIntegerValueSelector(content, "period", Messages.TRIX_Period, 1, 9999, DEFAULT_PERIOD); //$NON-NLS-1$
            }
        };
