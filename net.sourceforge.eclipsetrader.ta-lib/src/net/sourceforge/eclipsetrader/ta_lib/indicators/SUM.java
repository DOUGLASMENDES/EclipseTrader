...
public class SUM extends Factory
{
    public static final String DEFAULT_LABEL = Messages.SUM_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.SUM_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.SUM_Label, DEFAULT_LABEL); //$NON-NLS-1$
                addLineTypeSelector(content, "lineType", Messages.SUM_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addInputSelector(content, "input", Messages.SUM_Input, DEFAULT_INPUT, false); //$NON-NLS-1$
                addIntegerValueSelector(content, "period", Messages.SUM_Period, 1, 9999, DEFAULT_PERIOD); //$NON-NLS-1$
            }
        };
