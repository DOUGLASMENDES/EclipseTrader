...
public class ROC extends Factory
{
    public static final String DEFAULT_LABEL = Messages.ROC_DefaultLabel;
    ...
    public IndicatorPluginPreferencePage createPreferencePage()
    {
        IndicatorPluginPreferencePage page = new TALibIndicatorPreferencePage() {
            ...
            public void createControl(Composite parent)
            {
                ...
                addColorSelector(content, "color", Messages.ROC_Color, DEFAULT_COLOR); //$NON-NLS-1$
                addLabelField(content, "label", Messages.ROC_Label, DEFAULT_LABEL); //$NON-NLS-1$
                addLineTypeSelector(content, "lineType", Messages.ROC_LineType, DEFAULT_LINETYPE); //$NON-NLS-1$
                addInputSelector(content, "input", Messages.ROC_Input, DEFAULT_INPUT, false); //$NON-NLS-1$
                addIntegerValueSelector(content, "period", Messages.ROC_Period, 1, 9999, DEFAULT_PERIOD); //$NON-NLS-1$
            }
        };
