...
public class ConvertCurrencyAction implements IWorkbenchWindowActionDelegate, IViewActionDelegate
{
    ...
    {
        CurrencyConversionDialog dlg = new CurrencyConversionDialog(window.getShell());
        dlg.open();
    }
