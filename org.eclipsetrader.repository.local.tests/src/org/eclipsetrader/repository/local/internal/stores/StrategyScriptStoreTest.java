...
public class StrategyScriptStoreTest extends TestCase {
    ...
    public void testMarshalEmpty() throws Exception {
        ...
        assertEquals(prefix + "<strategy><bars/><instruments/></strategy>", marshal(object));
    }
    ...
    public void testMarshalInstruments() throws Exception {
        ...
        assertEquals(prefix + "<strategy><bars/><instruments><security>local:securities#1</security></instruments></strategy>", marshal(object));
    }
    ...
    public void testMarshalBars() throws Exception {
        ...
        StrategyScriptStore object = new StrategyScriptStore();
        object.putProperties(properties, null);
        assertEquals(prefix + "<strategy><bars><timeSpan>5min</timeSpan><timeSpan>1d</timeSpan></bars><instruments/></strategy>", marshal(object));
    }
