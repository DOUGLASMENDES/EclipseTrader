 ...
 */
public class TodayOHL implements ITodayOHL {
	private Double open;
	private Double high;
	private Double low;
	...
	public boolean equals(Object obj) {
		...
		return (getOpen() == other.getOpen() || (getOpen() != null && getOpen().equals(other.getOpen()))) &&
	...
	@Override
	public int hashCode() {
	    return 3 * (open != null ? open.hashCode() : 0) +
 	   		   7 * (high != null ? high.hashCode() : 0) +
 	   		   11 * (low != null ? low.hashCode() : 0);
	}
