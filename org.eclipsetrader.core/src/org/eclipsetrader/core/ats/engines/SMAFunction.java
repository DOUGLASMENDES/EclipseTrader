...
public class SMAFunction extends MAFunction {

    private static final long serialVersionUID = -5803332551238239248L;

    public SMAFunction() {
    }

    public SMAFunction(List<IBar> bars, int type, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        SMAFunction result = new SMAFunction(bars, Util.TYPE_SMA, period);
