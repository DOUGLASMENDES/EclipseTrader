...
public class JavaScriptStrategyContext {
    ...
    public static final String FUNCTION_ON_POSITION_OPEN = "onPositionOpen";
    public static final String FUNCTION_ON_POSITION_CHANGE = "onPositionChange";
    public static final String FUNCTION_ON_POSITION_CLOSE = "onPositionClose";
    ...
    private Function onPositionOpen;
    private Function onPositionChange;
    private Function onPositionClose;

    public JavaScriptStrategyContext(Scriptable sharedScope, ISecurity instrument, IScriptStrategy strategy) throws Exception {
        ...
        try {
            ...
            obj = scope.get(FUNCTION_ON_POSITION_OPEN, scope);
            if (obj instanceof Function) {
                onPositionOpen = (Function) obj;
            }

            obj = scope.get(FUNCTION_ON_POSITION_CHANGE, scope);
            if (obj instanceof Function) {
                onPositionChange = (Function) obj;
            }

            obj = scope.get(FUNCTION_ON_POSITION_CLOSE, scope);
            if (obj instanceof Function) {
                onPositionClose = (Function) obj;
            }
        } finally {
            Context.exit();
        }
    ...
    public void init() {
        Context cx = Context.enter();
        try {
            Object obj = scope.get(FUNCTION_INIT, scope);
            if (obj instanceof Function) {
    ...
    public void onPositionOpen(IPosition position) {
        Context cx = Context.enter();
        try {
            if (onPositionOpen != null) {
                onPositionOpen.call(cx, scope, scope, new Object[] {
                    position
                });
            }
    ...
    public void onPositionChange(IPosition position) {
        ...
        try {
            if (onPositionChange != null) {
                onPositionChange.call(cx, scope, scope, new Object[] {
                    position
                });
            }
            ScriptableObject.putProperty(scope, PROPERTY_POSITION, position);
    ...
    public void onPositionClose(IPosition position) {
        Context cx = Context.enter();
        try {
            if (onPositionClose != null) {
                onPositionClose.call(cx, scope, scope, new Object[] {
                    position
                });
            }
