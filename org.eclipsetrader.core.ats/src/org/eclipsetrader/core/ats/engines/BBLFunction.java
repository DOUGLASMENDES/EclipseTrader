...
public class BBLFunction extends BaseDataSeriesFunction {
    ...
    public BBLFunction(List<IBar> bars, int type, int period, double devs) {
        super(bars);
        this.type = type;
        this.period = period;
        this.devs = devs;
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        BBLFunction result = new BBLFunction(bars, Util.TYPE_SMA, period, devs);

        return result;
    }

    public Object jsFunction_crosses(BBLFunction other, Object value) throws Exception {
    ...
    private Object crosses(BBLFunction other, double value) throws Exception {
        updateData();
        other.updateData();
    ...
    protected Double calculateNextValue(double value) {
        ...
        core.bbands(startIdx, endIdx, inReal, period, devs, devs, Util.getTALib_MAType(type), outBegIdx, outNbElement, outTemp1, outTemp2, outReal);
