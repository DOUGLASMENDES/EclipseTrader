...
public class Messages extends NLS {
    ...
    private static final String BUNDLE_NAME = "org.eclipsetrader.directaworld.internal.core.connector.messages"; //$NON-NLS-1$
    ...
    public static String LoginDialog_ShellTitle;
