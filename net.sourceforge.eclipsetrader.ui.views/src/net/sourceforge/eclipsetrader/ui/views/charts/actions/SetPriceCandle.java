...
/**
 */
public class SetPriceCandle implements IViewActionDelegate, IWorkbenchWindowActionDelegate
{
  ...
  public void selectionChanged(IAction action, ISelection selection)
  {
    if (selection != null)
    {
      if (selection instanceof ChartSelection && selection.isEmpty() == false)
        action.setChecked(((ChartSelection)selection).getChartCanvas().getStyle() == ChartCanvas.CANDLES);
      else
