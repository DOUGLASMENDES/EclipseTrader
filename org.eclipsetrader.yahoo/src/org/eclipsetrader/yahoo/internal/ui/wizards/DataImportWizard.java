...
public class DataImportWizard extends Wizard implements IImportWizard {
	...
	public DataImportWizard() {
    	...
    	setDefaultPageImageDescriptor(YahooActivator.imageDescriptorFromPlugin(YahooActivator.PLUGIN_ID, "icons/wizban/import_wiz.png"));
	}
	...
	public boolean performFinish() {
		DataImportJob job = new DataImportJob(
				dataPage.getCheckedSecurities(),
				dataPage.getImportType(),
				dataPage.getFromDate(),
				dataPage.getToDate(),
				dataPage.getAggregation());
