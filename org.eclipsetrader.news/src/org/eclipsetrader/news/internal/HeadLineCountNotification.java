...
public class HeadLineCountNotification implements INotification, Comparable<HeadLineCountNotification> {
	...
	public HeadLineCountNotification(int count) {
		this.label = NLS.bind(LABEL_TEXT, new Object[] { "News" });
		this.description = NLS.bind(DESCRIPTION_TEXT, new Object[] { count });
	}
	...
	public void open() {
		...
		try {
			...
			Status status = new Status(Status.WARNING, Activator.PLUGIN_ID, 0, "Unexpected error activating view", null);
