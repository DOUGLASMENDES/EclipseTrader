...
public final class OptionChainCommand 
	...
	/**
	 * Creates new option chain command, initializing 
	 * all its properties.
	 * 
	 ...
	 */
	public OptionChainCommand(String exchangeCode,
			String symbolCode,
	 ...
	 * its default value of <code>null</code> (meaning "any").
	 * Initializes {@link #getVolumeStyle volumeStyle} property to
	 * its default value of {@link VolumeStyleEnum#COMPOUND COMPOUND}.
	 ...
	 * which defaults to <code>COMPOUND</code>.
	 * 
	 * @param exchangeCode exchange code.
	 * @param symbolCode symbol code.
	 * @param expiration expiration.
	...
	public OptionChainCommand(String exchangeCode,
			...
			MonthAndYear expiration,
			PriceRange strike) {
		this(exchangeCode, symbolCode, expiration, strike,
