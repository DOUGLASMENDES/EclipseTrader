 ...
 */
public final class OptionChainSnapshotRequest extends AbstractOptionChainRequest {

	public OptionChainSnapshotRequest(int requestId, 
			String exchangeCode,
			String symbolCode,
		...
		super(CommandEnum.REQUEST_OPTION_CHAIN_SNAPSHOT,
				requestId, 
				exchangeCode,
				symbolCode,
				expiration,
