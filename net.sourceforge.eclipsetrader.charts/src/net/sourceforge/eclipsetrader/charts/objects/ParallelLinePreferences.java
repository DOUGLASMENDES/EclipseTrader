...
public class ParallelLinePreferences extends ObjectPluginPreferencePage
{
    ...
    public void createControl(Composite parent)
    {
        ...
        valueOffset.setText(nf.format(getSettings().getDouble("valueOffset", null)));
    ...
    public void performFinish()
    {
        try
        {
            ...
            getSettings().set("valueOffset",nf.parse(valueOffset.getText()).doubleValue());
