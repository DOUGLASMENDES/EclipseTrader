...
/**
 */
public class OpenChartForAction implements IWorkbenchWindowActionDelegate
{
    ...
    public void run(IAction action)
    {
        if (security != null)
        {
            ...
            try {
                page.showView(ChartView.VIEW_ID, String.valueOf(security.getId()), IWorkbenchPage.VIEW_ACTIVATE);
