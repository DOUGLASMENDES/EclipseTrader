...
/**
 */
public class ChartSettingsAction implements IViewActionDelegate
{
    ...
    public void run(IAction action)
    {
        ...
        {
            ChartSettingsDialog dlg = new ChartSettingsDialog(((ChartView)part).getChart(), window.getShell());
            dlg.open();
        }
    }
