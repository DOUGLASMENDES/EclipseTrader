...
public class WatchlistSettingsAction implements IViewActionDelegate
{
    ...
    public void run(IAction action)
    {
        ...
        Watchlist watchlist = view.getWatchlist();
        WatchlistSettingsDialog dlg = new WatchlistSettingsDialog(watchlist, window.getShell());
        dlg.open();
    }
