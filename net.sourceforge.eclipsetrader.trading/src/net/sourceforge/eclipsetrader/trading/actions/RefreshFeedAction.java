...
public class RefreshFeedAction implements IWorkbenchWindowActionDelegate, IPropertyChangeListener
{
    private IAction action;

    public RefreshFeedAction()
    {
    }
    ...
    {
        CorePlugin.getDefault().getPreferenceStore().setValue(CorePlugin.FEED_RUNNING, true);
        while(PlatformUI.getWorkbench().getDisplay().readAndDispatch());
        
        FeedMonitor.snapshot();
        Level2FeedMonitor.snapshot();
