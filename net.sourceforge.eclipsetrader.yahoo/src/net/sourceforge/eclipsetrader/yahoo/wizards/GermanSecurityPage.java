...
public class GermanSecurityPage extends WizardPage implements ISecurityPage
{
    ...
    {
        super(""); //$NON-NLS-1$
        setTitle(Messages.GermanSecurityPage_Title);
        setDescription(Messages.GermanSecurityPage_Description);
    ...
    public void createControl(Composite parent)
    {
        ...
        tableColumn.setText(Messages.GermanSecurityPage_CodeColumnName);
        tableColumn = new TableColumn(table, SWT.NONE);
        tableColumn.setText(Messages.GermanSecurityPage_DescriptionColumnName);
        ...
        label.setText(Messages.GermanSecurityPage_Search);
        ...
        {
        	InputStream is = null;
        	File file = YahooPlugin.getDefault().getStateLocation().append("securities_de.xml").toFile(); //$NON-NLS-1$
        	if (file.exists())
        		is = new FileInputStream(file);
        	if (is == null)
        		FileLocator.openStream(YahooPlugin.getDefault().getBundle(), new Path("data/securities_de.xml"), false); //$NON-NLS-1$
