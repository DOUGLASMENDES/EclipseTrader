...
public class AskSizeFactory extends AbstractProviderFactory {
	...
	public class DataProvider implements IDataProvider {
        ...
        public IAdaptable getValue(IAdaptable adaptable) {
        	...
        	if (quote != null && quote.getAskSize() != null) {
        		final Long value = quote.getAskSize();
