...
public class CommonImages {
	...
	private static final URL baseURL = UIActivator.getDefault().getBundle().getEntry("/icons/"); //$NON-NLS-1$
	...
	public static final ImageDescriptor OVERLAY_SYNC_OLD_INCOMMING_NEW = create(T_EVIEW, "overlay-synch-incoming-new.gif"); //$NON-NLS-1$
