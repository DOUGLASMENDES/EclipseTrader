...
public class DataOpenHandler extends AbstractHandler {

    public DataOpenHandler() {
    }
            ...
            for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
                ...
                if (target instanceof ISecurity) {
                    ...
                    try {
                        ...
                        site.getPage().showView(HistoryDataEditorPart.VIEW_ID, dialogSettings.getName(), IWorkbenchPage.VIEW_ACTIVATE);
                    } catch (PartInitException e) {
                        Status status = new Status(IStatus.ERROR, UIActivator.PLUGIN_ID, 0, "Error opening data view", e); //$NON-NLS-1$
