...
public class MarketTest extends TestCase {
	...
	public void testIsOpenAtOpenTime() throws Exception {
		Market market = new Market("Test", Arrays.asList(new MarketTime[] { new MarketTime(getTime(9, 30), getTime(16, 0)) }));
	...
	public void testIsOpenOnSunday() throws Exception {
		Market market = new Market("Test", Arrays.asList(new MarketTime[] { new MarketTime(getTime(9, 30), getTime(16, 0)) }));
		market.setWeekDays(new Integer[] { Calendar.MONDAY, Calendar.TUESDAY, Calendar.WEDNESDAY, Calendar.THURSDAY, Calendar.FRIDAY, });
	    assertFalse(market.isOpen(getTime(2007, Calendar.NOVEMBER, 4, 1, 0)));
    }

	public void testIsOpenOnHoliday() throws Exception {
		Market market = new Market("Test", Arrays.asList(new MarketTime[] { new MarketTime(getTime(9, 30), getTime(16, 0)) }));
	    market.setHolidays(new MarketHoliday[] { new MarketHoliday(getTime(2007, Calendar.DECEMBER, 25), "Holiday") });
	...
	public void testIsPartiallyOpenOnHoliday() throws Exception {
		Market market = new Market("Test", Arrays.asList(new MarketTime[] { new MarketTime(getTime(9, 30), getTime(16, 0)) }));
	    market.setHolidays(new MarketHoliday[] { new MarketHoliday(getTime(2007, Calendar.DECEMBER, 31, 9, 30), getTime(2007, Calendar.DECEMBER, 31, 12, 30), "Holiday") });
	...
	public void testMarshalOpenTime() throws Exception {
		...
		Market object = new Market(null, Arrays.asList(new MarketTime[] { new MarketTime(date.getTime(), null) }));
	...
	public void testMarshalCloseTime() throws Exception {
		...
		Market object = new Market(null, Arrays.asList(new MarketTime[] { new MarketTime(null, date.getTime()) }));
