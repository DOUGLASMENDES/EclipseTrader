        	...
        	if (identifier != null) {
        		...
        		if (properties != null) {
        			if (properties.getProperty(IdentifiersList.SYMBOL_PROPERTY) != null) {
        				String symbol = properties.getProperty(IdentifiersList.SYMBOL_PROPERTY);
        				String exchange = properties.getProperty(IdentifiersList.EXCHANGE_PROPERTY);
        				final String value = exchange != null ? exchange + ":" + symbol : symbol;
