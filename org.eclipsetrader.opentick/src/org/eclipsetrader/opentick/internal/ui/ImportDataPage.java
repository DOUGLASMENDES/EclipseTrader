...
public class ImportDataPage extends WizardPage {
	...
	protected void restoreState() {
		IDialogSettings dialogSettings = OTActivator.getDefault().getDialogSettings().getSection(getClass().getName());
	...
	public void saveState() {
		IDialogSettings dialogSettings = OTActivator.getDefault().getDialogSettings().getSection(getClass().getName());
		if (dialogSettings == null)
			dialogSettings = OTActivator.getDefault().getDialogSettings().addNewSection(getClass().getName());
