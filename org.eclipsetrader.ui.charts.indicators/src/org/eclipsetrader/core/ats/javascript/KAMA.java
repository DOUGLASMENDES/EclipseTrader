...
public class KAMA extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.KAMA;
    ...
    public KAMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        KAMA result = new KAMA(bars, period);
    ...
    public Object jsFunction_crosses(KAMA other, Object bar) throws Exception {
        checkCalculate();
