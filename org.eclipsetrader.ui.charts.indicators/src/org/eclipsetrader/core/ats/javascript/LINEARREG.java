...
public class LINEARREG extends ScriptableObject {
    ...
    public LINEARREG(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        LINEARREG result = new LINEARREG(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.linearRegLookback(period);
        ...
        core.linearReg(startIdx, endIdx, inReal, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(LINEARREG other, Object bar) throws Exception {
        checkCalculate();
