...
public class APO extends ScriptableObject {
    ...
    public APO(List<IBar> bars, int fastPeriod, int slowPeriod) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        APO result = new APO(bars, fastPeriod, slowPeriod);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.apoLookback(fastPeriod, slowPeriod, MAType.getTALib_MAType(maType));
        ...
        core.apo(startIdx, endIdx, inReal, fastPeriod, slowPeriod, MAType.getTALib_MAType(maType), outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(APO other, Object bar) throws Exception {
        checkCalculate();
