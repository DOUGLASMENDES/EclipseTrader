...
public class MACDS extends ScriptableObject {
    ...
    public MACDS(List<IBar> bars, int fastPeriod, int slowPeriod, int signalPeriod) {
    ...
    public Object jsFunction_crosses(MACDS other, Object bar) throws Exception {
        checkCalculate();
