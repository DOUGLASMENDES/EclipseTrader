...
public class TYPPRICE extends ScriptableObject {
    ...
    public TYPPRICE(List<IBar> bars) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        TYPPRICE result = new TYPPRICE(bars);
    ...
    public Object jsFunction_crosses(TYPPRICE other, Object bar) throws Exception {
        checkCalculate();
