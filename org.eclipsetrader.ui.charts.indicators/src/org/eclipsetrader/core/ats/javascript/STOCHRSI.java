...
public class STOCHRSI extends ScriptableObject {
    ...
    public STOCHRSI(List<IBar> bars, int kFastPeriod, int kSlowPeriod) {
    ...
    public Object jsFunction_crosses(STOCHRSI other, Object bar) throws Exception {
        checkCalculate();
