...
public class ADX extends ScriptableObject {
    ...
    public ADX(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        ADX result = new ADX(bars, period);
    ...
    private void checkCalculate() {
        ...
        core.adx(startIdx, endIdx, inHigh, inLow, inClose, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(ADX other, Object bar) throws Exception {
        checkCalculate();
