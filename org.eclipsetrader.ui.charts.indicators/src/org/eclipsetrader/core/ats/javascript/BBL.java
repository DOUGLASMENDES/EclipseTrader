...
public class BBL extends ScriptableObject {
    ...
    public BBL(List<IBar> bars, int period, double deviation) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        BBL result = new BBL(bars, period, deviation);
    ...
    private void checkCalculate() {
        ...
        series = new NumericDataSeries(String.format("%s%d", getClassName(), period), outLower, source); //$NON-NLS-1$
    }
    ...
    public Object jsFunction_crosses(BBL other, Object bar) throws Exception {
        checkCalculate();
