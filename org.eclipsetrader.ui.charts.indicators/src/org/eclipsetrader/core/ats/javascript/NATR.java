...
public class NATR extends ScriptableObject {
    ...
    public NATR(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        NATR result = new NATR(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.natrLookback(period);
        ...
        core.natr(startIdx, endIdx, inHigh, inLow, inClose, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(NATR other, Object bar) throws Exception {
        checkCalculate();
