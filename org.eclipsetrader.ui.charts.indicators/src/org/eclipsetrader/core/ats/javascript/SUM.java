...
public class SUM extends ScriptableObject {
    ...
    public SUM(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        SUM result = new SUM(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.sumLookback(period);
        ...
        core.sum(startIdx, endIdx, inReal, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(SUM other, Object bar) throws Exception {
        checkCalculate();
