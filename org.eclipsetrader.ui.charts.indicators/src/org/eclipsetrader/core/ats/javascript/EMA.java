...
public class EMA extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.EMA;
    ...
    public EMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        EMA result = new EMA(bars, period);
    ...
    public Object jsFunction_crosses(EMA other, Object bar) throws Exception {
        checkCalculate();
