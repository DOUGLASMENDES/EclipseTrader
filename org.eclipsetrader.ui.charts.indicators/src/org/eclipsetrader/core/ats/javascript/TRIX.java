...
public class TRIX extends ScriptableObject {
    ...
    public TRIX(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        TRIX result = new TRIX(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.trixLookback(period);
        ...
        core.trix(startIdx, endIdx, inReal, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(TRIX other, Object bar) throws Exception {
        checkCalculate();
