...
public class SMA extends ScriptableObject {
    ...
    public SMA(IDataSeries source, int period) {
        this.source = source;
        this.period = period;
    }

    public SMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        SMA result = new SMA(bars, period);
    ...
    public Object jsFunction_crosses(SMA other, Object bar) throws Exception {
        checkCalculate();
