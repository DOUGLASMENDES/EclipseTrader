...
public class TEMA extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.TEMA;
    ...
    public TEMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        TEMA result = new TEMA(bars, period);
    ...
    public Object jsFunction_crosses(TEMA other, Object bar) throws Exception {
        checkCalculate();
