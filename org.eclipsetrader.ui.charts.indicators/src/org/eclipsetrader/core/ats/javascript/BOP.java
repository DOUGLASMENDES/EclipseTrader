...
public class BOP extends ScriptableObject {
    ...
    private void checkCalculate() {
        ...
        core.bop(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(BOP other, Object bar) throws Exception {
        checkCalculate();
