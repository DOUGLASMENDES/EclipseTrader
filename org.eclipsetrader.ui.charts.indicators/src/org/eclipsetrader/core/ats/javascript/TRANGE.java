...
public class TRANGE extends ScriptableObject {
    ...
    private void checkCalculate() {
        ...
        int lookback = core.trueRangeLookback();
        ...
        core.trueRange(startIdx, endIdx, inHigh, inLow, inClose, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(TRANGE other, Object bar) throws Exception {
        checkCalculate();
