...
public class AVGPRICE extends ScriptableObject {
    ...
    public AVGPRICE(List<IBar> bars) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        AVGPRICE result = new AVGPRICE(bars);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.avgPriceLookback();
        ...
        core.avgPrice(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(AVGPRICE other, Object bar) throws Exception {
        checkCalculate();
