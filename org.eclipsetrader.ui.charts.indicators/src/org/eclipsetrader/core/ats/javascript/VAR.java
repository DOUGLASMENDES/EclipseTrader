...
public class VAR extends ScriptableObject {
    ...
    public VAR(List<IBar> bars, int period, double deviation) {
    ...
    public Object jsFunction_crosses(VAR other, Object bar) throws Exception {
        checkCalculate();
