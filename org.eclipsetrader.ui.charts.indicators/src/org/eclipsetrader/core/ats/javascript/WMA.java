...
public class WMA extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.WMA;
    ...
    public WMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        WMA result = new WMA(bars, period);
    ...
    public Object jsFunction_crosses(WMA other, Object bar) throws Exception {
        checkCalculate();
