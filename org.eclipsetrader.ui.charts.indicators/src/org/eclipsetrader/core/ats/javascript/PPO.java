...
public class PPO extends ScriptableObject {
    ...
    public PPO(List<IBar> bars, int fastPeriod, int slowPeriod) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        PPO result = new PPO(bars, fastPeriod, slowPeriod);
    ...
    public Object jsFunction_crosses(PPO other, Object bar) throws Exception {
        checkCalculate();
