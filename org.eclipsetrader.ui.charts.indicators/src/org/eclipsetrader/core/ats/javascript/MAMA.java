...
public class MAMA extends ScriptableObject {
    ...
    public MAMA(List<IBar> bars, int period) {
    ...
    public Object jsFunction_crosses(MAMA other, Object bar) throws Exception {
        checkCalculate();
