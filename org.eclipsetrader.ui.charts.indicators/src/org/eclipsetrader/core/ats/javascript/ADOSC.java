...
public class ADOSC extends ScriptableObject {
    ...
    public ADOSC(List<IBar> bars, int fastPeriod, int slowPeriod) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        ADOSC result = new ADOSC(bars, fastPeriod, slowPeriod);
    ...
    public Object jsFunction_crosses(ADOSC other, Object bar) throws Exception {
        checkCalculate();
