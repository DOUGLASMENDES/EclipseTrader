...
public class T3 extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.T3;
    ...
    public T3(List<IBar> bars, int period) {
    ...
    public Object jsFunction_crosses(T3 other, Object bar) throws Exception {
        checkCalculate();
