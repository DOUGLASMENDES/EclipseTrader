...
public class BBU extends ScriptableObject {
    ...
    public BBU(List<IBar> bars, int period, double deviation) {
    ...
    public Object jsFunction_crosses(BBU other, Object bar) throws Exception {
        checkCalculate();
