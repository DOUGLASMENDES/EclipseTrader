...
public class RSI extends ScriptableObject {
    ...
    public RSI(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        RSI result = new RSI(bars, period);
    ...
    public Object jsFunction_crosses(RSI other, Object bar) throws Exception {
        checkCalculate();
