...
public class ADXR extends ScriptableObject {
    ...
    public ADXR(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        ADXR result = new ADXR(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.adxrLookback(period);
        ...
        core.adxr(startIdx, endIdx, inHigh, inLow, inClose, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(ADXR other, Object bar) throws Exception {
        checkCalculate();
