...
public class AROOND extends ScriptableObject {
    ...
    public AROOND(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        AROOND result = new AROOND(bars, period);
    ...
    private void checkCalculate() {
        ...
        series = new NumericDataSeries(String.format("%s%d", getClassName(), period), outDown, source); //$NON-NLS-1$
    }
    ...
    public Object jsFunction_crosses(AROOND other, Object bar) throws Exception {
        checkCalculate();
