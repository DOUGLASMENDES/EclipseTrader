...
public class TRIMA extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.TRIMA;
    ...
    public TRIMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        TRIMA result = new TRIMA(bars, period);
    ...
    public Object jsFunction_crosses(TRIMA other, Object bar) throws Exception {
        checkCalculate();
