...
public class SAR extends ScriptableObject {
    ...
    public SAR(List<IBar> bars, double acceleration, double maximum) {
    ...
    public Object jsFunction_crosses(SAR other, Object bar) throws Exception {
        checkCalculate();
