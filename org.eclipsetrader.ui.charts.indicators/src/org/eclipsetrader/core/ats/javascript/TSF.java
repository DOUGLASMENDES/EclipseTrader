...
public class TSF extends ScriptableObject {
    ...
    public TSF(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        TSF result = new TSF(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.tsfLookback(period);
        ...
        core.tsf(startIdx, endIdx, inReal, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(TSF other, Object bar) throws Exception {
        checkCalculate();
