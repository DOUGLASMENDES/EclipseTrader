...
public class CMO extends ScriptableObject {
    ...
    public CMO(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        CMO result = new CMO(bars, period);
    ...
    public Object jsFunction_crosses(CMO other, Object bar) throws Exception {
        checkCalculate();
