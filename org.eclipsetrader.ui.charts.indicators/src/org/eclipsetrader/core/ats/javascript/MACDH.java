...
public class MACDH extends ScriptableObject {
    ...
    public MACDH(List<IBar> bars, int fastPeriod, int slowPeriod, int signalPeriod) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        MACDH result = new MACDH(bars, fastPeriod, slowPeriod, signalPeriod);
    ...
    private void checkCalculate() {
        ...
        series = new NumericDataSeries(String.format("%s%d/%d/%d", getClassName(), fastPeriod, slowPeriod, signalPeriod), outMACDHist, source); //$NON-NLS-1$
    }
    ...
    public Object jsFunction_crosses(MACDH other, Object bar) throws Exception {
        checkCalculate();
