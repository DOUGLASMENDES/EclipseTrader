...
public class DEMA extends ScriptableObject {
    ...
    private int period;
    private final MAType type = MAType.DEMA;
    ...
    public DEMA(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        DEMA result = new DEMA(bars, period);
    ...
    public Object jsFunction_crosses(DEMA other, Object bar) throws Exception {
        checkCalculate();
