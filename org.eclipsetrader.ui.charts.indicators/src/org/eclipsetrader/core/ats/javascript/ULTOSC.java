...
public class ULTOSC extends ScriptableObject {
    ...
    public ULTOSC(List<IBar> bars, int shortPeriod, int mediumPeriod, int longPeriod) {
    ...
    public Object jsFunction_crosses(ULTOSC other, Object bar) throws Exception {
        checkCalculate();
