...
public class MOM extends ScriptableObject {
    ...
    public MOM(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        MOM result = new MOM(bars, period);
    ...
    public Object jsFunction_crosses(MOM other, Object bar) throws Exception {
        checkCalculate();
