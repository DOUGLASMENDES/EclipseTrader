...
public class MFI extends ScriptableObject {
    ...
    public MFI(List<IBar> bars, int period) {
    ...
    public static Object jsConstructor(Context cx, Object[] args, Function ctorObj, boolean inNewExpr) {
        ...
        MFI result = new MFI(bars, period);
    ...
    private void checkCalculate() {
        ...
        int lookback = core.mfiLookback(period);
        ...
        core.mfi(startIdx, endIdx, inHigh, inLow, inClose, inVolume, period, outBegIdx, outNbElement, outReal);
    ...
    public Object jsFunction_crosses(MFI other, Object bar) throws Exception {
        checkCalculate();
