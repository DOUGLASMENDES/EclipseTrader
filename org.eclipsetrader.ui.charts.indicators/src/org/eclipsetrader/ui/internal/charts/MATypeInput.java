...
public class MATypeInput extends Observable {
	private Label label;
	private ComboViewer combo;

	public MATypeInput(Composite parent) {
		this(parent, (String) null);
	}

	public MATypeInput(Composite parent, String text) {
		if (text != null) {
	...
	public MATypeInput(Composite parent, Label label) {
		this.label = label;
		initializeCombo(parent);
	}
