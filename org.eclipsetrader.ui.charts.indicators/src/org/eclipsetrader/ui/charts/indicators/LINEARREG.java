...
public class LINEARREG implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public LINEARREG(int period, OHLCField field) {
        this.period = period;
        this.field = field;
    }
