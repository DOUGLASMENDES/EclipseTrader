...
public class VAR implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartParameters getParameters() {
        ...
        parameters.setParameter("deviation", deviation);
    ...
    public void setParameters(IChartParameters parameters) {
        ...
        deviation = parameters.getDouble("deviation");
