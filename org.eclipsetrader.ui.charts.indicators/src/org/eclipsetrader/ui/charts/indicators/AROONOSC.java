...
public class AROONOSC implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartObject createObject(IDataSeries source) {
        ...
        int lookback = core.aroonOscLookback(period);
        ...
        core.aroonOsc(startIdx, endIdx, inHigh, inLow, period, outBegIdx, outNbElement, outReal);
