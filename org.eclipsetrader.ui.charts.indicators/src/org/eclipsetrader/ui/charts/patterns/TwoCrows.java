...
public class TwoCrows implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartObject createObject(IDataSeries source) {
        ...
        int lookback = core.cdl2CrowsLookback();
        ...
        core.cdl2Crows(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outInteger);
