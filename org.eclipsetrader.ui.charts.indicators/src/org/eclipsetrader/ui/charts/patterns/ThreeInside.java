...
public class ThreeInside implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartObject createObject(IDataSeries source) {
        ...
        int lookback = core.cdl3InsideLookback();
        ...
        core.cdl3Inside(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outInteger);
