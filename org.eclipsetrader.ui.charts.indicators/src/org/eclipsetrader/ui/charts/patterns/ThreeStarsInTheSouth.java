...
import org.eclipsetrader.ui.internal.charts.PatternChart;
...
public class ThreeStarsInTheSouth implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartObject createObject(IDataSeries source) {
        ...
        int lookback = core.cdl3StarsInSouthLookback();
        ...
        core.cdl3StarsInSouth(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outInteger);
