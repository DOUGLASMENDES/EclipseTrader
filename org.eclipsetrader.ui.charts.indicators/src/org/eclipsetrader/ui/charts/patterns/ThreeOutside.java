...
public class ThreeOutside implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
	private String id;
	...
	public IChartObject createObject(IDataSeries source) {
		...
		core.cdl3Outside(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outInteger);
