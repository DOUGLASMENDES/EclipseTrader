...
public class ThreeLineStrike implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
	private String id;
	...
	public IChartObject createObject(IDataSeries source) {
		...
		int lookback = core.cdl3LineStrikeLookback();
		...
		core.cdl3LineStrike(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outInteger);
