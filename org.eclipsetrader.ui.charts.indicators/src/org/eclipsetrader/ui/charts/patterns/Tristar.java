...
public class Tristar implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartObject createObject(IDataSeries source) {
        ...
        int lookback = core.cdlTristarLookback();
        ...
        core.cdlTristar(startIdx, endIdx, inOpen, inHigh, inLow, inClose, outBegIdx, outNbElement, outInteger);
